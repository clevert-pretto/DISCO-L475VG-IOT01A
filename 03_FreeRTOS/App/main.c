...
/********************* Private definitions and Macros ends ********************/
...
int main(void)
{
    ...
    */
    ...
    xTaskCreateStatic(HeartBeatTask,            // Function
                      "HeartBeatTask",          // Name
    ...
    xTaskCreate(vPrintqueuetask,                // Function
                "printQueueTask",               // Name
    ...
    xTaskCreateStatic(tempSensorTask,                 // Function
                      "tempSensorTask",               // Name
                      (configMINIMAL_STACK_SIZE * 2), // Stack Size
                      (void *)NULL,                   // Parameter
                      1,                              // Priority
